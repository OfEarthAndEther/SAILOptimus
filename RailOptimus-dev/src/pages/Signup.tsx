  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await signup({
        ...
        passwordConfirm: formData.confirmPassword, // Backend expects this field
      });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Create Logistics Officer Account
          </p>
        </div>
        ...
        <Card className="shadow-strong border-border">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Create your Logistics Officer account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="section">Port</Label>
                <Input
                  id="section"
                  name="section"
                  type="text"
